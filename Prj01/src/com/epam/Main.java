...
public class Main {
    ...
    public static void main(String[] args) throws IlluminanceTooLittleException, SpaceUsageTooMuchException, IlluminanceTooMuchException {
        ...
        building.addRoom("Комната 1", 100.00, 3);
        building.addRoom("Комната 2", 5, 2);
        building.getRoom("Комната 1").add(new Light(150));
        building.getRoom("Комната 1").add(new Light(250));
        building.getRoom("Комната 1").add(new Table("Стол письменный", 3));
        building.getRoom("Комната 1").add(new Armchair("Кресло мягкое и пушистое", 1, 2));
        building.describe();
